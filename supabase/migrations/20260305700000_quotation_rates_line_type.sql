-- Add line_type (mobile/landline/others) from network: 3 rows per country
-- Keep rate_type (International, Origin Based, Local) as columns
-- Returns one row per (country, upload, line_type, rate_type)
