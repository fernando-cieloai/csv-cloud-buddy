-- Add p_search_by to support search by country, prefix, or type
-- Fix type search (was only filtering by country before)
...
DROP FUNCTION IF EXISTS get_quotation_countries_count(uuid[], text[], text);
